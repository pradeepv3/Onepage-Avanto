<div class="sec-services">
    <div class="container text-center">
        ...
        <div class="row">
            <div class="col-12 col-xws-6 col-sm-6 col-lg-3 mb-4 mb-lg-0 sec-services__item">
                <div class="sec-service_content">
            ...
            <div class="col-12 col-xws-6 col-sm-6 col-lg-3 mb-4 mb-lg-0 sec-services__item">
                <div class="sec-service_content">
                    ...
                    <p class="sec-services__text">Fusce aliquet quam eget neque ultrices elementum. Nulla posuere Maecenas cursus felis.</p>
                    <a href="" class="btn">Read more</a>
                </div>
            </div>
