	...
	<div class="container controls">
		...
		<div class="sec-ourwork-controls text-center">
			...
			<ul class="list-unstyled list-inline mb-3 text-uppercase work-filter" id="menu-filter">
				...
				<li class="list-inline-item"><a class="filter" data-filter=".web-design">Web Design</a></li>
				<li class="list-inline-item"><a class="filter" data-filter=".fill-logo">Logo</a></li>
			</ul>
